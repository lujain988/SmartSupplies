...
//           ${discountHTML} 
//           <a href="../Cart/Cart.html" onclick="add(${product.id},'${product.productName}',${product.price},'${imageUrl}')" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
//           <br>
...
//   let url = `https://localhost:44381/filterOnCategory?category=${(
//     category
//   )}`;
